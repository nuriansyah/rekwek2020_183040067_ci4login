...
<div class="container">
    <div class="row">
        <div class="col-8">
            <h2 class="my-3">Form Ubah Data Comics</h2>
            <form action="/comics/update/<?= $comics['id']; ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <input type="hidden" name="slug" id="" value="<?= $comics['slug']; ?>">
                <input type="hidden" name="sampulLame" value="<?= $comics['sampul']; ?>">
                <div class="form-group row">
                    <label for="judul" class="col-sm-2 col-form-label">Judul</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control <?= ($validation->hasError('judul')) ? 'is-invalid' : ''; ?>" id="judul" name="judul" value="<?= (old('judul')) ? old('judul') : $comics['judul'] ?>" autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <img src="/img/<?= $comics['sampul']; ?>" class="img-thumbnail img-preview" alt="">
                    </div>
                    <div class="col-sm-10">
